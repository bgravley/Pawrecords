...
# U.S. DOT/ACAA rules recognize qualifying trained service dogs on flights to,
# within, and from the U.S., while preserving safety, health, foreign-law,
# disruption, and permitted-form conditions.
