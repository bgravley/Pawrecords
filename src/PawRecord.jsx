...
const AIScanModal=({dog,userId,userEmail,onSave,onClose})=>{
  ...
  const saveAll=async()=>{
    ...
    try{
      ...
      if(include.weight&&extracted.weight)await db.addWeight(userId,{dogId:dog.id,date:extracted.visitDate||today(),weight:parseFloat(extracted.weight),notes:"From AI scan"});
